...
describe("test WktVisitor", () => {
    it("test generate WKT for empty point", () => {
    ...
    it("test generate WKT for point with coordinates", () => {
    ...
    it("test generate WKT for empty linestring", () => {
    ...
    it("test generate WKT for linestring with coordinates", () => {
